...
latest_repro_comment='https://github.com/dusk-network/hyperlane-dusk/issues/2#issuecomment-4443963744'
...
if [ -f "$EXPORT_DIR/dusk-pr-3-body.txt" ]; then
    ...
    rg -q -F 'https://github.com/dusk-network/hyperlane-dusk/actions/runs/25818138725/job/75851960627' \
        "$EXPORT_DIR/dusk-pr-3-body.txt" \
        || fail "$EXPORT_DIR/dusk-pr-3-body.txt is missing current dispatcher gate run link"
    rg -q -F 'https://github.com/dusk-network/hyperlane-dusk/actions/runs/25818138768/job/75851960495' \
        "$EXPORT_DIR/dusk-pr-3-body.txt" \
