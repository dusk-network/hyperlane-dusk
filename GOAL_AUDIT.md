...
- `make gate-status` prints the current machine-checkable gate status:
  ...
  `make production-readiness-guard`, branch protection/status-check policy, and
