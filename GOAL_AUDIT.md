...
| Component | Branch | Head | State |
|---|---|---|---|
| `dusk-network/hyperlane-dusk` | `feat/dusk-hardening-v2` | `0a23b6b62bedf1856bb8f4c65bb0764cd216e743` | Internal PR open, mergeable |
...
| Put local `~/projects/hyperlane/dusk` under git and push | Dusk repo branch `feat/dusk-hardening-v2`, current head `0a23b6b` | Done |
...
| Prepare internal Dusk PR for contracts/tooling/tests/audit notes | Dusk PR #1 is open and mergeable; body and comments include current evidence through `0a23b6b` | Done |
| Prepare internal Dusk PR for Hyperlane agent/protocol integration | Monorepo PR #1 is open and mergeable; body and comments include companion Dusk evidence through `0a23b6b` | Done |
