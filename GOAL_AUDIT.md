...
- `make gate-status` prints the current machine-checkable gate status:
  ...
  `make production-readiness-guard`, and latest clean-layout repro path delta.
