...
| Live-head delta after latest clean-layout repro | The live Dusk and monorepo PR heads are checked through GitHub and `make gate-status`. Latest clean-layout repro run `1778671118` covers Dusk implementation source ref `93ed3b07b26d8784610d2ba754a851490de15e21` and validated monorepo runtime ref `48dcc0c87efc12584904d841d5088c1ae4acef20`; subsequent Dusk docs/guard-only commits are outside `DUSK_REPRO_COVERED_PATHS`, and the production-readiness guard reports `coveredPathDelta: none`. Later monorepo head `9050143c1ef12f76d117ee97effa79da8df3e334` changes only `docs/dusk-upstream-compatibility-review.md` and `docs/dusk-upstream-pr-plan.md`. |
