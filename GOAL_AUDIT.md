...
- `make gate-status` prints the current machine-checkable gate status:
  ...
  `make completion-audit-status`, `make review-gates`, and latest
  clean-layout repro path delta.
