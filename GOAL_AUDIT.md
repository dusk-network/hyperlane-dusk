...
| Local EVM <-> Dusk with TestMock/null-style ISM | Clean Rusk run `1778520709`: bidirectional E2E passed; review-head clean-Rusk run `1778587094` passed at Dusk `2ac225175b15aac465d100e748ba68f8b14bd545` and monorepo `a44020dc998b7fe868254a5d1a349b9eb8ded899` | Done |
| Local EVM <-> Dusk with MessageIdMultisigISM | Clean Rusk run `1778521018`: bidirectional E2E with validator/checkpoint passed; review-head clean-Rusk run `1778587351` passed at Dusk `2ac225175b15aac465d100e748ba68f8b14bd545` and monorepo `a44020dc998b7fe868254a5d1a349b9eb8ded899` | Done |
| Bidirectional DUSK/wDUSK bridge through relayer/validator, no manual process calls | `TEST_REPORT.md` records relayer/validator-driven EVM -> Dusk and Dusk -> EVM flows for TestMock and MessageIdMultisig; review-head runs `1778587094` and `1778587351` passed both directions with generated Dusk signer key cleanup verified | Done |
| E2E freshness against current runtime source | `TEST_REPORT.md` records the 2026-05-12 diff check: Dusk changes after review-head E2E source ref `2ac225175b15aac465d100e748ba68f8b14bd545` and before latest tested source ref `aa278208b2c2b5f4abc38c32ec792295080014a9` are docs/workflow/reference/hygiene only after the previously tested `de9b7fa3c832fb60982d3dbd22c8a59114d37732` source ref; monorepo changes after review-head E2E ref `a44020dc998b7fe868254a5d1a349b9eb8ded899` and before the live monorepo PR head are Dusk upstream-plan docs plus upstream TypeScript infra/config only | Done |
...
| Live-head delta after latest clean-layout repro | From tested Dusk source ref `836ee7d8d8e95152b3daaeebbc3fb56b0cc8e253` to live PR head `48907f3e75546662dadf502eea73f085391a89aa`, `git diff --name-status` reports only `GOAL_AUDIT.md`, `TEST_REPORT.md`, and `scripts/github-review-hygiene.sh`. The commits are `26c2850` evidence docs, `45f62b9` review-hygiene stale-link guard, and `48907f3` evidence wording clarification. |
