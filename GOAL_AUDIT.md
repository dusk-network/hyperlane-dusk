...
- Manual workflow dispatcher PR #3 is ready for review, open, has
  ...
  head `13eaca26336820e27b862ecf3cfccc564a47e751` merge cleanly in either
...
| Live-head delta after latest clean-layout repro | The live Dusk and monorepo PR heads are checked through GitHub and `make gate-status`. Latest clean-layout repro run `1778695627` covers Dusk source ref `ef8ee43cd99569299b9744b498ac1bbac69950bc` and monorepo ref `515fab074024271935bc7795604dbb4f0823a937`; the current monorepo PR head is rebased onto upstream `7689ff65f4929a72ad0650a03e8dd7d987f0e802`. Subsequent Dusk docs/report/guard commits through `13eaca26336820e27b862ecf3cfccc564a47e751` are outside `DUSK_REPRO_COVERED_PATHS`, and the production-readiness guard reports `coveredPathDelta: none`. `make gate-status-fresh` and `make production-readiness-guard` also compare the live monorepo PR head against `LATEST_REPRO_MONOREPO_REF`; current output reports `monorepoCoveredPathDelta: none`. The latest post-push Dusk PR #1 check URLs at `13eaca26336820e27b862ecf3cfccc564a47e751` are review policy success https://github.com/dusk-network/hyperlane-dusk/actions/runs/25819297778/job/75856037468 and expected production-readiness failure https://github.com/dusk-network/hyperlane-dusk/actions/runs/25819297742/job/75856036345. |
