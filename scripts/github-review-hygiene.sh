...
latest_repro_comment='https://github.com/dusk-network/hyperlane-dusk/issues/2#issuecomment-4440209335'
...
if [ -f "$EXPORT_DIR/dusk-pr-3-body.txt" ]; then
    ...
    rg -q -F 'https://github.com/dusk-network/hyperlane-dusk/actions/runs/25767765098/job/75684050585' \
